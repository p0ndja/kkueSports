...
<body>
    ...
    <div class="container">
        <h2 class="font-weight-bold text-md">บุคลากรสายสนับสนุน</h2>
        <div class="row mb-3">
            <div class="col-md-3">
                <div class="card mb-3">
                    <ul class="nav md-pills pills-success flex-column" role="tablist">
                        <?php
                            $fol = glob("../static/elements/people/staff/*", GLOB_ONLYDIR);
                            ...
                            <script>
                                function createNewCategory() {
                                    ...
                                    if (folderName != null && folderName != "") {
                                        window.location = "../pages/people_IO.php?function=create&top=staff&mkdir=" + folderName;
                                    }
                                }
                                        ...
                                        <div class="card card-cascade wider mb-4">
                                            ...
                                            <div style="display: none;" id="targetEditZone_<?php echo $file_name;?>">
                                                <form method="POST" action="../pages/people_IO.php?function=update&id=<?php echo $f; ?>&target=<?php echo $fi; ?>" enctype="multipart/form-data">
                                                    <input type="hidden" name="path" value="../static/elements/people/staff/<?php echo $folder_name; ?>/">
                                                    <div class="view view-cascade overlay">
